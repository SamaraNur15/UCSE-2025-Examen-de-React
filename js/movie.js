...
const getMovieDetails = async () => {
  try {
    ...
    if (movie) {
      ...
      movieDetailsContainer.innerHTML = '<p class="error">Película no encontrada.</p>'
    }
  } catch (error) {
    movieDetailsContainer.innerHTML = '<p class="error">Error al cargar los detalles de la película.</p>'
  }
}
